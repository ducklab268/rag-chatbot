...
LLM_MODEL = "gpt2"
MAX_CONTEXT_TOKENS = 500  # max words for prompt
...
def get_answer(query: str, k=4):
    ...
    out = generator(prompt, max_new_tokens=200, num_return_sequences=1)
    text = out[0]["generated_text"]
    # remove repeated prompt part
...
if __name__ == "__main__":
    ...
    build_index()
    print("✅ Index built. Use get_answer(query) from app.py")
